...
VERSION_URL="https://api.github.com/repos/$USER/$REPO/contents/version-MF.txt?ref=$BRANCH"
SCRIPT_URL="https://api.github.com/repos/$USER/$REPO/contents/printers-MF.sh?ref=$BRANCH"
...
TOOL_NAME="IT Aman - Printer Tool For MF v 1.0"
